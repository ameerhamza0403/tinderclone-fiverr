      ...
      <ScrollView>
        <View style={styles.mainContainer}>
          ...
          <View style={styles.viewContainer}>
            ...
            <View style={{flex:6,justifyContent: 'flex-end',marginTop:20, marginBottom: 10,flexDirection: 'column', width: '90%', marginLeft: '1%'}}>
              ...
              <View style={{flex:1}}>
                            ...
                            <View
                                            style={{flex:8,marginTop: 30, marginBottom: 5,ali:'center',justifyContent:'center'}}>
                                            <Text
                                              style={{
